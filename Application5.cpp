...
int Application5::Initialize()
{
	 ...
	 */ 
 	m_nWidth = 128;		// frame buffer and display width
	m_nHeight = 128;    // frame buffer and display height
...
{ 
	...
	*/
	...
	//GzColor specularCoefficient = { 0, 0, 0};
	//GzColor diffuseCoefficient = { 0, 0, 0 };
